...
"[project]/src/hooks/service_auth.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function authPerson(data) {
    let datos = null;
    try {
        datos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$Connection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["POST_AC"])("login", data);
    } catch (error) {
        console.log(error);
        return error;
    }
...
async function validarToken(token) {
    let datos = null;
    try {
        datos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$Connection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GET_AC"])("validar", token);
    } catch (error) {
...
"[project]/src/app/session/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$service_auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/service_auth.js [app-ssr] (ecmascript)");
...
function login() {
    const loginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.object().shape({
        email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.string().trim().required("Ingresa tu correo"),
        password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.string().trim().required("Ingresa tu contraseña")
    });
    ...
    const { register, handleSubmit, formState } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useForm"])(formOptions);
    let { errors } = formState;
    const req = (data)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$service_auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authPerson"])(data).then((info)=>{
            if (info.code == 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("token", info.token);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("usuario", info.person);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("necesary", info.necesary);
...
"[project]/src/app/session/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__04e3b3._.js.map